...
export const metadata: Metadata = {
  ...
  description: "Системийн эхний админ хэрэглэгчийг хамгаалалттайгаар үүсгэх.",
};
    ...
    <main className="login-shell">
      <section className="login-card" aria-labelledby="setup-title">
        ...
        <div className="login-copy">
          ...
          <h1 id="setup-title">Эхний админ үүсгэх</h1>
          <p>
      ...
      <aside className="login-security-panel">
        ...
        <ul className="check-list">
          <li>Эхний хэрэглэгч системийн админ эрхтэй үүснэ.</li>
