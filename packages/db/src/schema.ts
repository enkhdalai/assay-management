...
export const customerOrganizationProfiles = pgTable(
  "customer_organization_profiles",
  {
    ...
    postalAddressEncrypted: text("postal_address_encrypted"),
    englishName: varchar("english_name", { length: 255 }),
    legacyTypeCode: varchar("legacy_type_code", { length: 32 }),
...
export const bullionIntakeBatches = pgTable(
  "bullion_intake_batches",
  {
    ...
    silverTiter: numeric("silver_titer", { precision: 14, scale: 6 }),
...
export const bullionCertificates = pgTable("bullion_certificates", {
  ...
  signerCertificate: text("signer_certificate"),
  certificateChain: jsonb("certificate_chain"),
  signatureAlgorithm: varchar("signature_algorithm", { length: 96 }),
  ...
  uniqueIndex("bullion_certificates_verification_uidx").on(table.verificationId),
...
export const bullionExaminationRevisions = pgTable(
  "bullion_examination_revisions",
  {
    ...
    returnedByUserId: uuid("returned_by_user_id").references(() => users.id, { onDelete: "restrict" }),
    ...
    silverMethod: varchar("silver_method", { length: 32 }),
    silverTiterMilligramsPerMilliliter: numeric("silver_titer_mg_per_ml", { precision: 14, scale: 6 }),
    silverBlankVolumeMilliliters: numeric("silver_blank_volume_ml", { precision: 14, scale: 6 }),
